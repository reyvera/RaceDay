  ...
  var TrackerReactComponent = function (_Component) {                                                               // 25
    ...
    TrackerReactComponent.prototype.autorunOnce = function () {                                                     // 25
      function autorunOnce(name, dataFunc) {                                                                        // 25
        return _Tracker2['default'].once(name, this, dataFunc, this.forceUpdate);                                   // 69
      }                                                                                                             // 70
                                                                                                                    //
 ...
 */                                                                                                                 //
                                                                                                                    //
                                                                                                                    //
var TrackerReactMixin = exports.TrackerReactMixin = {                                                               // 85
  ...
  autorunOnce: function () {                                                                                        // 107
    function autorunOnce(name, dataFunc) {                                                                          // 85
      return _Tracker2['default'].once(name, this, dataFunc, this.forceUpdate);                                     // 108
    }                                                                                                               // 109
                                                                                                                    //
...
_tracker.Tracker.once = function (name, context, dataFunc, updateFunc) {                                            // 12
  ...
  context[name] = _tracker.Tracker.nonreactive(function () {                                                        // 19
